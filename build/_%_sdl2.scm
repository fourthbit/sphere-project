...
(include "/usr/local/Gambit-C/spheres/sdl2/src/sdl2-prelude.scm")
(c-define-constants
 SDL_INIT_TIMER
 SDL_INIT_AUDIO
 SDL_INIT_VIDEO
...
(define SDL_AUDIO_BITSIZE
  (c-lambda
   (SDL_AudioFormat)
   SDL_AudioFormat
   "___result = SDL_AUDIO_BITSIZE(___arg1);"))
(define SDL_AUDIO_ISFLOAT
  (c-lambda
   (SDL_AudioFormat)
   SDL_AudioFormat
   "___result = SDL_AUDIO_ISFLOAT(___arg1);"))
(define SDL_AUDIO_ISBIGENDIAN
  (c-lambda
   (SDL_AudioFormat)
   SDL_AudioFormat
   "___result = SDL_AUDIO_ISBIGENDIAN(___arg1);"))
(define SDL_AUDIO_ISSIGNED
  (c-lambda
   (SDL_AudioFormat)
   SDL_AudioFormat
   "___result = SDL_AUDIO_ISSIGNED(___arg1);"))
(define SDL_AUDIO_ISINT
  (c-lambda
   (SDL_AudioFormat)
   SDL_AudioFormat
   "___result = SDL_AUDIO_ISINT(___arg1);"))
(define SDL_AUDIO_ISLITTLEENDIAN
  (c-lambda
   (SDL_AudioFormat)
   SDL_AudioFormat
   "___result = SDL_AUDIO_ISLITTLEENDIAN(___arg1);"))
(define SDL_AUDIO_ISUNSIGNED
  (c-lambda
   (SDL_AudioFormat)
   SDL_AudioFormat
   "___result = SDL_AUDIO_ISUNSIGNED(___arg1);"))
(c-define-constants
 AUDIO_U8
 AUDIO_S8
 AUDIO_U16LSB
 ...
 AUDIO_S32SYS
 AUDIO_F32SYS)
(c-define-constants SDL_AUDIO_STOPPED SDL_AUDIO_PLAYING SDL_AUDIO_PAUSED)
(c-define-constants
 SDL_BLENDMODE_NONE
 SDL_BLENDMODE_BLEND
 SDL_BLENDMODE_ADD
...
(c-define-constants SDL_HINT_DEFAULT SDL_HINT_NORMAL SDL_HINT_OVERRIDE)
...
(c-define-constants SDL_FLIP_NONE SDL_FLIP_HORIZONTAL SDL_FLIP_VERTICAL)
(c-define-constants
 SDL_SYSWM_UNKNOWN
 SDL_SYSWM_WINDOWS
 SDL_SYSWM_X11
...
(c-define-constants SDL_WINDOWPOS_CENTERED SDL_WINDOWPOS_UNDEFINED)
(cond-expand
 (sdl:assert
  (c-define-constants
   SDL_ASSERTION_RETRY
 ...
 (else #!void))
(c-define-constants SDL_FALSE SDL_TRUE)
(c-define-struct
 SDL_AudioCVT
 (needed int)
...
(define SDL_AddEventWatch
  (c-lambda (SDL_EventFilter void*) void "SDL_AddEventWatch"))
(define SDL_AddHintCallback
  (c-lambda
   (nonnull-char-string SDL_HintCallback void*)
   void
   "SDL_AddHintCallback"))
(define SDL_AddTimer
  (c-lambda
   (unsigned-int32 SDL_TimerCallback void*)
   SDL_TimerID
   "SDL_AddTimer"))
(define SDL_AllocFormat
  (c-lambda (unsigned-int32) SDL_PixelFormat* "SDL_AllocFormat"))
(define SDL_AllocPalette (c-lambda (int) SDL_Palette* "SDL_AllocPalette"))
(define SDL_AllocRW (c-lambda () SDL_RWops* "SDL_AllocRW"))
(cond-expand
 (android (define SDL_AndroidGetActivity
            (c-lambda () void* "SDL_AndroidGetActivity"))
          ...
          (define SDL_AndroidGetExternalStorageState
            (c-lambda () int "SDL_AndroidGetExternalStorageState"))
          ...
          (define SDL_AndroidGetJNIEnv
            (c-lambda () void* "SDL_AndroidGetJNIEnv")))
 (else #!void))
(cond-expand
 (sdl:atomic
  (define SDL_AtomicAdd (c-lambda (SDL_atomic_t* int) int "SDL_AtomicAdd"))
  (define SDL_AtomicCAS
    (c-lambda (SDL_atomic_t* int int) SDL_bool "SDL_AtomicCAS"))
  (define SDL_AtomicCASPtr
    (c-lambda (void** void* void*) SDL_bool "SDL_AtomicCASPtr"))
  (define SDL_AtomicDecRef
    (c-lambda (SDL_atomic_t*) SDL_bool "SDL_AtomicDecRef"))
  ...
  (define SDL_AtomicTryLock
    (c-lambda (SDL_SpinLock*) SDL_bool "SDL_AtomicTryLock"))
...
(define SDL_CalculateGammaRamp
  (c-lambda (float unsigned-int16*) void "SDL_CalculateGammaRamp"))
...
(define SDL_CloseAudioDevice
  (c-lambda (SDL_AudioDeviceID) void "SDL_CloseAudioDevice"))
...
(define SDL_CondWaitTimeout
  (c-lambda (SDL_cond* SDL_mutex* unsigned-int32) int "SDL_CondWaitTimeout"))
(define SDL_ConvertAudio (c-lambda (SDL_AudioCVT*) int "SDL_ConvertAudio"))
(define SDL_ConvertPixels
  (c-lambda
   (int int unsigned-int32 void* int unsigned-int32 void* int)
   int
   "SDL_ConvertPixels"))
(define SDL_ConvertSurface
  (c-lambda
   (SDL_Surface* SDL_PixelFormat* unsigned-int32)
   SDL_Surface*
   "SDL_ConvertSurface"))
(define SDL_ConvertSurfaceFormat
  (c-lambda
   (SDL_Surface* unsigned-int32 unsigned-int32)
   SDL_Surface*
   "SDL_ConvertSurfaceFormat"))
(define SDL_CreateColorCursor
  (c-lambda (SDL_Surface* int int) SDL_Cursor* "SDL_CreateColorCursor"))
(define SDL_CreateCond (c-lambda () SDL_cond* "SDL_CreateCond"))
(define SDL_CreateCursor
  (c-lambda
   (unsigned-int8* unsigned-int8* int int int int)
   SDL_Cursor*
   "SDL_CreateCursor"))
...
(define SDL_CreateRenderer
  (c-lambda
   (SDL_Window* int unsigned-int32)
   SDL_Renderer*
   "SDL_CreateRenderer"))
(define SDL_CreateSemaphore
  (c-lambda (unsigned-int32) SDL_sem* "SDL_CreateSemaphore"))
(define SDL_CreateSoftwareRenderer
  (c-lambda (SDL_Surface*) SDL_Renderer* "SDL_CreateSoftwareRenderer"))
(define SDL_CreateSystemCursor
  (c-lambda (SDL_SystemCursor) SDL_Cursor* "SDL_CreateSystemCursor"))
(define SDL_CreateTexture
  (c-lambda
   (SDL_Renderer* unsigned-int32 int int int)
   SDL_Texture*
   "SDL_CreateTexture"))
...
(cond-expand
 (sdl:threads
  (define SDL_CreateThread
    (c-lambda
     (SDL_ThreadFunction nonnull-char-string void*)
     SDL_Thread*
     "SDL_CreateThread")))
 (else #!void))
(define SDL_CreateWindow
  (c-lambda
   (nonnull-char-string int int int int unsigned-int32)
   SDL_Window*
   "SDL_CreateWindow"))
(define SDL_CreateWindowAndRenderer
  (c-lambda
   (int int unsigned-int32 SDL_Window** SDL_Renderer**)
   int
   "SDL_CreateWindowAndRenderer"))
(define SDL_CreateWindowFrom
  (c-lambda (void*) SDL_Window* "SDL_CreateWindowFrom"))
(define SDL_DelEventWatch
  (c-lambda (SDL_EventFilter void*) void "SDL_DelEventWatch"))
...
(cond-expand
 (sdl:threads
  (define SDL_DestroySemaphore
    (c-lambda (SDL_sem*) void "SDL_DestroySemaphore")))
 (else #!void))
...
(define SDL_EnclosePoints
  (c-lambda (SDL_Point* int SDL_Rect* SDL_Rect*) SDL_bool "SDL_EnclosePoints"))
(define SDL_EventState
  (c-lambda (unsigned-int32 int) unsigned-int8 "SDL_EventState"))
(define SDL_FillRect
  (c-lambda (SDL_Surface* SDL_Rect* unsigned-int32) int "SDL_FillRect"))
(define SDL_FillRects
  (c-lambda (SDL_Surface* SDL_Rect* int unsigned-int32) int "SDL_FillRects"))
(define SDL_FilterEvents
  (c-lambda (SDL_EventFilter void*) void "SDL_FilterEvents"))
(define SDL_FlushEvent (c-lambda (unsigned-int32) void "SDL_FlushEvent"))
(define SDL_FlushEvents
  (c-lambda (unsigned-int32 unsigned-int32) void "SDL_FlushEvents"))
...
(define SDL_GL_BindTexture
  (c-lambda (SDL_Texture* float* float*) int "SDL_GL_BindTexture"))
...
(define SDL_GL_ExtensionSupported
  (c-lambda (nonnull-char-string) SDL_bool "SDL_GL_ExtensionSupported"))
(define SDL_GL_GetAttribute
  (c-lambda (SDL_GLattr int*) int "SDL_GL_GetAttribute"))
(define SDL_GL_GetCurrentContext
  (c-lambda () SDL_GLContext "SDL_GL_GetCurrentContext"))
(define SDL_GL_GetCurrentWindow
  (c-lambda () SDL_Window* "SDL_GL_GetCurrentWindow"))
(define SDL_GL_GetDrawableSize
  (c-lambda (SDL_Window* int* int*) void "SDL_GL_GetDrawableSize"))
(define SDL_GL_GetProcAddress
  (c-lambda (nonnull-char-string) void* "SDL_GL_GetProcAddress"))
(define SDL_GL_GetSwapInterval (c-lambda () int "SDL_GL_GetSwapInterval"))
(define SDL_GL_LoadLibrary
  (c-lambda (nonnull-char-string) int "SDL_GL_LoadLibrary"))
(define SDL_GL_MakeCurrent
  (c-lambda (SDL_Window* SDL_GLContext) int "SDL_GL_MakeCurrent"))
(define SDL_GL_ResetAttributes (c-lambda () void "SDL_GL_ResetAttributes"))
(define SDL_GL_SetAttribute
  (c-lambda (SDL_GLattr int) int "SDL_GL_SetAttribute"))
...
(define SDL_GL_UnbindTexture
  (c-lambda (SDL_Texture*) int "SDL_GL_UnbindTexture"))
(define SDL_GL_UnloadLibrary (c-lambda () void "SDL_GL_UnloadLibrary"))
(cond-expand
 (sdl:game-controller
  (define SDL_GameControllerAddMapping
    (c-lambda (nonnull-char-string) int "SDL_GameControllerAddMapping"))
  ...
  (define SDL_GameControllerAddMappingsFromRW
    (c-lambda (SDL_RWops* int) int "SDL_GameControllerAddMappingsFromRW"))
  (define SDL_GameControllerClose
    (c-lambda (SDL_GameController*) void "SDL_GameControllerClose"))
  (define SDL_GameControllerEventState
    (c-lambda (int) int "SDL_GameControllerEventState"))
  (define SDL_GameControllerGetAttached
    (c-lambda (SDL_GameController*) SDL_bool "SDL_GameControllerGetAttached"))
  ...
  (define SDL_GameControllerGetBindForAxis
    (c-lambda
     (SDL_GameController* SDL_GameControllerAxis)
  ...
  (define SDL_GameControllerMapping
    (c-lambda
     (SDL_GameController*)
     nonnull-char-string
  ...
  (define SDL_GameControllerNameForIndex
    (c-lambda (int) nonnull-char-string "SDL_GameControllerNameForIndex"))
  (define SDL_GameControllerOpen
    (c-lambda (int) SDL_GameController* "SDL_GameControllerOpen"))
  (define SDL_GameControllerUpdate
    (c-lambda () void "SDL_GameControllerUpdate")))
 (else #!void))
(cond-expand
 (sdl:assert
  (define SDL_GetAssertionReport
    (c-lambda () SDL_assert_data* "SDL_GetAssertionReport")))
 (else #!void))
(define SDL_GetAudioDeviceName
  (c-lambda (int int) nonnull-char-string "SDL_GetAudioDeviceName"))
(define SDL_GetAudioDeviceStatus
  (c-lambda (SDL_AudioDeviceID) SDL_AudioStatus "SDL_GetAudioDeviceStatus"))
(define SDL_GetAudioDriver
  (c-lambda (int) nonnull-char-string "SDL_GetAudioDriver"))
...
(define SDL_GetClipRect
  (c-lambda (SDL_Surface* SDL_Rect*) void "SDL_GetClipRect"))
(define SDL_GetClipboardText
  (c-lambda () nonnull-char-string "SDL_GetClipboardText"))
...
(define SDL_GetColorKey
  (c-lambda (SDL_Surface* unsigned-int32*) int "SDL_GetColorKey"))
(define SDL_GetCurrentAudioDriver
  (c-lambda () nonnull-char-string "SDL_GetCurrentAudioDriver"))
(define SDL_GetCurrentDisplayMode
  (c-lambda (int SDL_DisplayMode*) int "SDL_GetCurrentDisplayMode"))
(define SDL_GetCurrentVideoDriver
  (c-lambda () nonnull-char-string "SDL_GetCurrentVideoDriver"))
...
(cond-expand
 (sdl:assert
  (define SDL_GetDefaultAssertionHandler
    (c-lambda () SDL_AssertionHandler "SDL_GetDefaultAssertionHandler")))
 (else #!void))
(define SDL_GetDesktopDisplayMode
  (c-lambda (int SDL_DisplayMode*) int "SDL_GetDesktopDisplayMode"))
(define SDL_GetDisplayBounds
  (c-lambda (int SDL_Rect*) int "SDL_GetDisplayBounds"))
(define SDL_GetDisplayMode
  (c-lambda (int int SDL_DisplayMode*) int "SDL_GetDisplayMode"))
(define SDL_GetDisplayName
  (c-lambda (int) nonnull-char-string "SDL_GetDisplayName"))
(define SDL_GetError (c-lambda () nonnull-char-string "SDL_GetError"))
(define SDL_GetEventFilter
  (c-lambda (SDL_EventFilter* void**) SDL_bool "SDL_GetEventFilter"))
(define SDL_GetHint
  (c-lambda (nonnull-char-string) nonnull-char-string "SDL_GetHint"))
(define SDL_GetKeyFromName
  (c-lambda (nonnull-char-string) SDL_Keycode "SDL_GetKeyFromName"))
(define SDL_GetKeyFromScancode
  (c-lambda (SDL_Scancode) SDL_Keycode "SDL_GetKeyFromScancode"))
(define SDL_GetKeyName
  (c-lambda (SDL_Keycode) nonnull-char-string "SDL_GetKeyName"))
(define SDL_GetKeyboardFocus (c-lambda () SDL_Window* "SDL_GetKeyboardFocus"))
(define SDL_GetKeyboardState
  (c-lambda (int*) unsigned-int8* "SDL_GetKeyboardState"))
...
(define SDL_GetMouseState
  (c-lambda (int* int*) unsigned-int32 "SDL_GetMouseState"))
...
(define SDL_GetNumTouchFingers
  (c-lambda (SDL_TouchID) int "SDL_GetNumTouchFingers"))
...
(define SDL_GetPixelFormatName
  (c-lambda (unsigned-int32) nonnull-char-string "SDL_GetPixelFormatName"))
(define SDL_GetPlatform (c-lambda () nonnull-char-string "SDL_GetPlatform"))
(define SDL_GetPowerInfo
  (c-lambda (int* int*) SDL_PowerState "SDL_GetPowerInfo"))
...
(define SDL_GetRelativeMouseMode
  (c-lambda () SDL_bool "SDL_GetRelativeMouseMode"))
(define SDL_GetRelativeMouseState
  (c-lambda (int* int*) unsigned-int32 "SDL_GetRelativeMouseState"))
(define SDL_GetRenderDrawBlendMode
  (c-lambda (SDL_Renderer* SDL_BlendMode*) int "SDL_GetRenderDrawBlendMode"))
(define SDL_GetRenderDrawColor
  (c-lambda
   (SDL_Renderer* unsigned-int8* unsigned-int8* unsigned-int8* unsigned-int8*)
   int
   "SDL_GetRenderDrawColor"))
(define SDL_GetRenderDriverInfo
  (c-lambda (int SDL_RendererInfo*) int "SDL_GetRenderDriverInfo"))
(define SDL_GetRenderTarget
  (c-lambda (SDL_Renderer*) SDL_Texture* "SDL_GetRenderTarget"))
(define SDL_GetRenderer
  (c-lambda (SDL_Window*) SDL_Renderer* "SDL_GetRenderer"))
(define SDL_GetRendererInfo
  (c-lambda (SDL_Renderer* SDL_RendererInfo*) int "SDL_GetRendererInfo"))
(define SDL_GetRendererOutputSize
  (c-lambda (SDL_Renderer* int* int*) int "SDL_GetRendererOutputSize"))
...
(define SDL_GetScancodeFromKey
  (c-lambda (SDL_Keycode) SDL_Scancode "SDL_GetScancodeFromKey"))
(define SDL_GetScancodeFromName
  (c-lambda (nonnull-char-string) SDL_Scancode "SDL_GetScancodeFromName"))
(define SDL_GetScancodeName
  (c-lambda (SDL_Scancode) nonnull-char-string "SDL_GetScancodeName"))
(define SDL_GetSurfaceAlphaMod
  (c-lambda (SDL_Surface* unsigned-int8*) int "SDL_GetSurfaceAlphaMod"))
(define SDL_GetSurfaceBlendMode
  (c-lambda (SDL_Surface* SDL_BlendMode*) int "SDL_GetSurfaceBlendMode"))
(define SDL_GetSurfaceColorMod
  (c-lambda
   (SDL_Surface* unsigned-int8* unsigned-int8* unsigned-int8*)
   int
   "SDL_GetSurfaceColorMod"))
(define SDL_GetSystemRAM (c-lambda () int "SDL_GetSystemRAM"))
(define SDL_GetTextureAlphaMod
  (c-lambda (SDL_Texture* unsigned-int8*) int "SDL_GetTextureAlphaMod"))
(define SDL_GetTextureBlendMode
  (c-lambda (SDL_Texture* SDL_BlendMode*) int "SDL_GetTextureBlendMode"))
(define SDL_GetTextureColorMod
  (c-lambda
   (SDL_Texture* unsigned-int8* unsigned-int8* unsigned-int8*)
   int
   "SDL_GetTextureColorMod"))
(cond-expand
 (sdl:threads
  (define SDL_GetThreadID
    (c-lambda (SDL_Thread*) SDL_threadID "SDL_GetThreadID"))
  (define SDL_GetThreadName
    (c-lambda (SDL_Thread*) nonnull-char-string "SDL_GetThreadName")))
 (else #!void))
...
(define SDL_GetTouchFinger
  (c-lambda (SDL_TouchID int) SDL_Finger* "SDL_GetTouchFinger"))
(define SDL_GetVersion (c-lambda (SDL_version*) void "SDL_GetVersion"))
(define SDL_GetVideoDriver
  (c-lambda (int) nonnull-char-string "SDL_GetVideoDriver"))
(define SDL_GetWindowBrightness
  (c-lambda (SDL_Window*) float "SDL_GetWindowBrightness"))
(define SDL_GetWindowData
  (c-lambda (SDL_Window* nonnull-char-string) void* "SDL_GetWindowData"))
(define SDL_GetWindowDisplayIndex
  (c-lambda (SDL_Window*) int "SDL_GetWindowDisplayIndex"))
(define SDL_GetWindowDisplayMode
  (c-lambda (SDL_Window* SDL_DisplayMode*) int "SDL_GetWindowDisplayMode"))
(define SDL_GetWindowFlags
  (c-lambda (SDL_Window*) unsigned-int32 "SDL_GetWindowFlags"))
(define SDL_GetWindowFromID
  (c-lambda (unsigned-int32) SDL_Window* "SDL_GetWindowFromID"))
(define SDL_GetWindowGammaRamp
  (c-lambda
   (SDL_Window* unsigned-int16* unsigned-int16* unsigned-int16*)
   int
   "SDL_GetWindowGammaRamp"))
(define SDL_GetWindowGrab
  (c-lambda (SDL_Window*) SDL_bool "SDL_GetWindowGrab"))
(define SDL_GetWindowID
  (c-lambda (SDL_Window*) unsigned-int32 "SDL_GetWindowID"))
(define SDL_GetWindowMaximumSize
  (c-lambda (SDL_Window* int* int*) void "SDL_GetWindowMaximumSize"))
(define SDL_GetWindowMinimumSize
  (c-lambda (SDL_Window* int* int*) void "SDL_GetWindowMinimumSize"))
(define SDL_GetWindowPixelFormat
  (c-lambda (SDL_Window*) unsigned-int32 "SDL_GetWindowPixelFormat"))
(define SDL_GetWindowPosition
  (c-lambda (SDL_Window* int* int*) void "SDL_GetWindowPosition"))
...
(define SDL_GetWindowTitle
  (c-lambda (SDL_Window*) nonnull-char-string "SDL_GetWindowTitle"))
(define SDL_GetWindowWMInfo
  (c-lambda (SDL_Window* SDL_SysWMinfo*) SDL_bool "SDL_GetWindowWMInfo"))
(cond-expand
 (sdl:haptic
  (define SDL_HapticClose (c-lambda (SDL_Haptic*) void "SDL_HapticClose"))
  (define SDL_HapticDestroyEffect
    (c-lambda (SDL_Haptic* int) void "SDL_HapticDestroyEffect"))
  (define SDL_HapticEffectSupported
    (c-lambda (SDL_Haptic* SDL_HapticEffect*) int "SDL_HapticEffectSupported"))
  (define SDL_HapticGetEffectStatus
    (c-lambda (SDL_Haptic* int) int "SDL_HapticGetEffectStatus"))
  ...
  (define SDL_HapticNewEffect
    (c-lambda (SDL_Haptic* SDL_HapticEffect*) int "SDL_HapticNewEffect"))
  (define SDL_HapticNumAxes (c-lambda (SDL_Haptic*) int "SDL_HapticNumAxes"))
  (define SDL_HapticNumEffects
    (c-lambda (SDL_Haptic*) int "SDL_HapticNumEffects"))
  (define SDL_HapticNumEffectsPlaying
    (c-lambda (SDL_Haptic*) int "SDL_HapticNumEffectsPlaying"))
  (define SDL_HapticOpen (c-lambda (int) SDL_Haptic* "SDL_HapticOpen"))
  (cond-expand
   (sdl:joystick
    (define SDL_HapticOpenFromJoystick
      (c-lambda (SDL_Joystick*) SDL_Haptic* "SDL_HapticOpenFromJoystick")))
   (else #!void))
  (define SDL_HapticOpenFromMouse
    (c-lambda () SDL_Haptic* "SDL_HapticOpenFromMouse"))
  ...
  (define SDL_HapticQuery
    (c-lambda (SDL_Haptic*) unsigned-int "SDL_HapticQuery"))
  (define SDL_HapticRumbleInit
    (c-lambda (SDL_Haptic*) int "SDL_HapticRumbleInit"))
  (define SDL_HapticRumblePlay
    (c-lambda (SDL_Haptic* float unsigned-int32) int "SDL_HapticRumblePlay"))
  (define SDL_HapticRumbleStop
    (c-lambda (SDL_Haptic*) int "SDL_HapticRumbleStop"))
  (define SDL_HapticRumbleSupported
    (c-lambda (SDL_Haptic*) int "SDL_HapticRumbleSupported"))
  (define SDL_HapticRunEffect
    (c-lambda (SDL_Haptic* int unsigned-int32) int "SDL_HapticRunEffect"))
  (define SDL_HapticSetAutocenter
    (c-lambda (SDL_Haptic* int) int "SDL_HapticSetAutocenter"))
  (define SDL_HapticSetGain
    (c-lambda (SDL_Haptic* int) int "SDL_HapticSetGain"))
  (define SDL_HapticStopAll (c-lambda (SDL_Haptic*) int "SDL_HapticStopAll"))
  (define SDL_HapticStopEffect
    (c-lambda (SDL_Haptic* int) int "SDL_HapticStopEffect"))
  (define SDL_HapticUnpause (c-lambda (SDL_Haptic*) int "SDL_HapticUnpause"))
  (define SDL_HapticUpdateEffect
    (c-lambda
     (SDL_Haptic* int SDL_HapticEffect*)
     int
...
(define SDL_HasEvents
  (c-lambda (unsigned-int32 unsigned-int32) SDL_bool "SDL_HasEvents"))
(define SDL_HasIntersection
  (c-lambda (SDL_Rect* SDL_Rect*) SDL_bool "SDL_HasIntersection"))
...
(define SDL_HasScreenKeyboardSupport
  (c-lambda () SDL_bool "SDL_HasScreenKeyboardSupport"))
...
(define SDL_IntersectRect
  (c-lambda (SDL_Rect* SDL_Rect* SDL_Rect*) SDL_bool "SDL_IntersectRect"))
(define SDL_IntersectRectAndLine
  (c-lambda
   (SDL_Rect* int* int* int* int*)
   SDL_bool
   "SDL_IntersectRectAndLine"))
(cond-expand
 (sdl:game-controller
  (define SDL_IsGameController
    (c-lambda (int) SDL_bool "SDL_IsGameController")))
 (else #!void))
(define SDL_IsScreenKeyboardShown
  (c-lambda (SDL_Window*) SDL_bool "SDL_IsScreenKeyboardShown"))
(define SDL_IsScreenSaverEnabled
  (c-lambda () SDL_bool "SDL_IsScreenSaverEnabled"))
(define SDL_IsTextInputActive (c-lambda () SDL_bool "SDL_IsTextInputActive"))
(cond-expand
 (sdl:joystick
  (define SDL_JoystickClose
    (c-lambda (SDL_Joystick*) void "SDL_JoystickClose"))
  (define SDL_JoystickEventState (c-lambda (int) int "SDL_JoystickEventState"))
  (define SDL_JoystickGetAttached
    (c-lambda (SDL_Joystick*) SDL_bool "SDL_JoystickGetAttached"))
  (define SDL_JoystickGetAxis
    (c-lambda (SDL_Joystick* int) int16 "SDL_JoystickGetAxis"))
  (define SDL_JoystickGetBall
    (c-lambda (SDL_Joystick* int int* int*) int "SDL_JoystickGetBall"))
  (define SDL_JoystickGetButton
    (c-lambda (SDL_Joystick* int) unsigned-int8 "SDL_JoystickGetButton"))
  (define SDL_JoystickGetHat
    (c-lambda (SDL_Joystick* int) unsigned-int8 "SDL_JoystickGetHat"))
  (define SDL_JoystickInstanceID
    (c-lambda (SDL_Joystick*) SDL_JoystickID "SDL_JoystickInstanceID"))
  (define SDL_JoystickIsHaptic
    (c-lambda (SDL_Joystick*) int "SDL_JoystickIsHaptic"))
  (define SDL_JoystickName
    (c-lambda (SDL_Joystick*) nonnull-char-string "SDL_JoystickName"))
  (define SDL_JoystickNameForIndex
    (c-lambda (int) nonnull-char-string "SDL_JoystickNameForIndex"))
  (define SDL_JoystickNumAxes
    (c-lambda (SDL_Joystick*) int "SDL_JoystickNumAxes"))
  (define SDL_JoystickNumBalls
    (c-lambda (SDL_Joystick*) int "SDL_JoystickNumBalls"))
  (define SDL_JoystickNumButtons
    (c-lambda (SDL_Joystick*) int "SDL_JoystickNumButtons"))
  (define SDL_JoystickNumHats
    (c-lambda (SDL_Joystick*) int "SDL_JoystickNumHats"))
 ...
 (else #!void))
(define SDL_LoadBMP
  (c-lambda (nonnull-char-string) SDL_Surface* "SDL_LoadBMP"))
(define SDL_LoadBMP_RW
  (c-lambda (SDL_RWops* int) SDL_Surface* "SDL_LoadBMP_RW"))
(define SDL_LoadDollarTemplates
  (c-lambda (SDL_TouchID SDL_RWops*) int "SDL_LoadDollarTemplates"))
(define SDL_LoadFunction
  (c-lambda (void* nonnull-char-string) void* "SDL_LoadFunction"))
(define SDL_LoadObject (c-lambda (nonnull-char-string) void* "SDL_LoadObject"))
(define SDL_LoadWAV
  (c-lambda
   (nonnull-char-string SDL_AudioSpec* unsigned-int8** unsigned-int32*)
   SDL_AudioSpec*
   "SDL_LoadWAV"))
(define SDL_LoadWAV_RW
  (c-lambda
   (SDL_RWops* int SDL_AudioSpec* unsigned-int8** unsigned-int32*)
   SDL_AudioSpec*
   "SDL_LoadWAV_RW"))
(define SDL_LockAudio (c-lambda () void "SDL_LockAudio"))
(define SDL_LockAudioDevice
  (c-lambda (SDL_AudioDeviceID) void "SDL_LockAudioDevice"))
...
(define SDL_LockTexture
  (c-lambda (SDL_Texture* SDL_Rect* void** int*) int "SDL_LockTexture"))
(define SDL_Log
  (c-lambda (nonnull-char-string) void "SDL_Log(\"%s\", ___arg1);"))
(define SDL_LogCritical
  (c-lambda
   (int nonnull-char-string)
   void
   "SDL_LogCritical(___arg1, \"%s\", ___arg2);"))
(define SDL_LogDebug
  (c-lambda
   (int nonnull-char-string)
   void
   "SDL_LogDebug(___arg1, \"%s\", ___arg2);"))
(define SDL_LogError
  (c-lambda
   (int nonnull-char-string)
   void
   "SDL_LogError(___arg1, \"%s\", ___arg2);"))
(define SDL_LogGetOutputFunction
  (c-lambda (SDL_LogOutputFunction* void**) void "SDL_LogGetOutputFunction"))
(define SDL_LogGetPriority
  (c-lambda (int) SDL_LogPriority "SDL_LogGetPriority"))
(define SDL_LogInfo
  (c-lambda
   (int nonnull-char-string)
   void
   "SDL_LogInfo(___arg1, \"%s\", ___arg2);"))
(define SDL_LogMessage
  (c-lambda
   (int SDL_LogPriority nonnull-char-string)
   void
   "SDL_LogMessage(___arg1, ___arg2, \"%s\", ___arg3);"))
(define SDL_LogResetPriorities (c-lambda () void "SDL_LogResetPriorities"))
(define SDL_LogSetAllPriority
  (c-lambda (SDL_LogPriority) void "SDL_LogSetAllPriority"))
(define SDL_LogSetOutputFunction
  (c-lambda (SDL_LogOutputFunction void*) void "SDL_LogSetOutputFunction"))
(define SDL_LogSetPriority
  (c-lambda (int SDL_LogPriority) void "SDL_LogSetPriority"))
(define SDL_LogVerbose
  (c-lambda
   (int nonnull-char-string)
   void
   "SDL_LogVerbose(___arg1, \"%s\", ___arg2);"))
(define SDL_LogWarn
  (c-lambda
   (int nonnull-char-string)
   void
   "SDL_LogWarn(___arg1, \"%s\", ___arg2);"))
...
(define SDL_MapRGB
  (c-lambda
   (SDL_PixelFormat* unsigned-int8 unsigned-int8 unsigned-int8)
   unsigned-int32
   "SDL_MapRGB"))
(define SDL_MapRGBA
  (c-lambda
   (SDL_PixelFormat* unsigned-int8 unsigned-int8 unsigned-int8 unsigned-int8)
   unsigned-int32
   "SDL_MapRGBA"))
(define SDL_MasksToPixelFormatEnum
  (c-lambda
   (int unsigned-int32 unsigned-int32 unsigned-int32 unsigned-int32)
   unsigned-int32
...
(define SDL_MixAudio
  (c-lambda
   (unsigned-int8* unsigned-int8* unsigned-int32 int)
   void
   "SDL_MixAudio"))
(define SDL_MixAudioFormat
  (c-lambda
   (unsigned-int8* unsigned-int8* SDL_AudioFormat unsigned-int32 int)
   void
   "SDL_MixAudioFormat"))
(define SDL_MouseIsHaptic (c-lambda () int "SDL_MouseIsHaptic"))
(define SDL_NumHaptics (c-lambda () int "SDL_NumHaptics"))
(cond-expand
 (sdl:joystick (define SDL_NumJoysticks (c-lambda () int "SDL_NumJoysticks")))
 (else #!void))
(define SDL_OpenAudio
  (c-lambda (SDL_AudioSpec* SDL_AudioSpec*) int "SDL_OpenAudio"))
(define SDL_OpenAudioDevice
  (c-lambda
   (nonnull-char-string int SDL_AudioSpec* SDL_AudioSpec* int)
   SDL_AudioDeviceID
   "SDL_OpenAudioDevice"))
(define SDL_PauseAudio (c-lambda (int) void "SDL_PauseAudio"))
(define SDL_PauseAudioDevice
  (c-lambda (SDL_AudioDeviceID int) void "SDL_PauseAudioDevice"))
(define SDL_PeepEvents
  (c-lambda
   (SDL_Event* int SDL_eventaction unsigned-int32 unsigned-int32)
   int
   "SDL_PeepEvents"))
...
(define SDL_QueryTexture
  (c-lambda
   (SDL_Texture* unsigned-int32* int* int* int*)
   int
   "SDL_QueryTexture"))
...
(define SDL_RWFromConstMem
  (c-lambda (void* int) SDL_RWops* "SDL_RWFromConstMem"))
...
(define SDL_RWread
  (c-lambda (SDL_RWops* void* size-t size-t) size-t "SDL_RWread"))
...
(define SDL_RWwrite
  (c-lambda (SDL_RWops* void* size-t size-t) size-t "SDL_RWwrite"))
...
(define SDL_RectEquals
  (c-lambda (SDL_Rect* SDL_Rect*) SDL_bool "SDL_RectEquals"))
(define SDL_RegisterEvents
  (c-lambda (int) unsigned-int32 "SDL_RegisterEvents"))
...
(define SDL_RenderDrawLine
  (c-lambda (SDL_Renderer* int int int int) int "SDL_RenderDrawLine"))
(define SDL_RenderDrawLines
  (c-lambda (SDL_Renderer* SDL_Point* int) int "SDL_RenderDrawLines"))
(define SDL_RenderDrawPoint
  (c-lambda (SDL_Renderer* int int) int "SDL_RenderDrawPoint"))
(define SDL_RenderDrawPoints
  (c-lambda (SDL_Renderer* SDL_Point* int) int "SDL_RenderDrawPoints"))
(define SDL_RenderDrawRect
  (c-lambda (SDL_Renderer* SDL_Rect*) int "SDL_RenderDrawRect"))
(define SDL_RenderDrawRects
  (c-lambda (SDL_Renderer* SDL_Rect* int) int "SDL_RenderDrawRects"))
(define SDL_RenderFillRect
  (c-lambda (SDL_Renderer* SDL_Rect*) int "SDL_RenderFillRect"))
(define SDL_RenderFillRects
  (c-lambda (SDL_Renderer* SDL_Rect* int) int "SDL_RenderFillRects"))
(define SDL_RenderGetClipRect
  (c-lambda (SDL_Renderer* SDL_Rect*) void "SDL_RenderGetClipRect"))
(define SDL_RenderGetLogicalSize
  (c-lambda (SDL_Renderer* int* int*) void "SDL_RenderGetLogicalSize"))
(define SDL_RenderGetScale
  (c-lambda (SDL_Renderer* float* float*) void "SDL_RenderGetScale"))
(define SDL_RenderGetViewport
  (c-lambda (SDL_Renderer* SDL_Rect*) void "SDL_RenderGetViewport"))
(define SDL_RenderPresent (c-lambda (SDL_Renderer*) void "SDL_RenderPresent"))
(define SDL_RenderReadPixels
  (c-lambda
   (SDL_Renderer* SDL_Rect* unsigned-int32 void* int)
   int
   "SDL_RenderReadPixels"))
(define SDL_RenderSetClipRect
  (c-lambda (SDL_Renderer* SDL_Rect*) int "SDL_RenderSetClipRect"))
(define SDL_RenderSetLogicalSize
  (c-lambda (SDL_Renderer* int int) int "SDL_RenderSetLogicalSize"))
(define SDL_RenderSetScale
  (c-lambda (SDL_Renderer* float float) int "SDL_RenderSetScale"))
(define SDL_RenderSetViewport
  (c-lambda (SDL_Renderer* SDL_Rect*) int "SDL_RenderSetViewport"))
(define SDL_RenderTargetSupported
  (c-lambda (SDL_Renderer*) SDL_bool "SDL_RenderTargetSupported"))
(cond-expand
 (sdl:assert
  (define SDL_ResetAssertionReport
    (c-lambda () void "SDL_ResetAssertionReport")))
 (else #!void))
(define SDL_RestoreWindow (c-lambda (SDL_Window*) void "SDL_RestoreWindow"))
(define SDL_SaveAllDollarTemplates
  (c-lambda (SDL_RWops*) int "SDL_SaveAllDollarTemplates"))
(define SDL_SaveBMP
  (c-lambda (SDL_Surface* nonnull-char-string) int "SDL_SaveBMP"))
(define SDL_SaveBMP_RW
  (c-lambda (SDL_Surface* SDL_RWops* int) int "SDL_SaveBMP_RW"))
(define SDL_SaveDollarTemplate
  (c-lambda (SDL_GestureID SDL_RWops*) int "SDL_SaveDollarTemplate"))
(cond-expand
 (sdl:threads
  ...
  (define SDL_SemWaitTimeout
    (c-lambda (SDL_sem* unsigned-int32) int "SDL_SemWaitTimeout")))
 (else #!void))
(cond-expand
 (sdl:assert
  (define SDL_SetAssertionHandler
    (c-lambda (SDL_AssertionHandler void*) void "SDL_SetAssertionHandler")))
 (else #!void))
(define SDL_SetClipRect
  (c-lambda (SDL_Surface* SDL_Rect*) SDL_bool "SDL_SetClipRect"))
(define SDL_SetClipboardText
  (c-lambda (nonnull-char-string) int "SDL_SetClipboardText"))
(define SDL_SetColorKey
  (c-lambda (SDL_Surface* int unsigned-int32) int "SDL_SetColorKey"))
(define SDL_SetCursor (c-lambda (SDL_Cursor*) void "SDL_SetCursor"))
(define SDL_SetError
  (c-lambda (nonnull-char-string) int "SDL_SetError(\"%s\", ___arg1);"))
(define SDL_SetEventFilter
  (c-lambda (SDL_EventFilter void*) void "SDL_SetEventFilter"))
(define SDL_SetHint
  (c-lambda (nonnull-char-string nonnull-char-string) SDL_bool "SDL_SetHint"))
(define SDL_SetHintWithPriority
  (c-lambda
   (nonnull-char-string nonnull-char-string SDL_HintPriority)
   SDL_bool
...
(define SDL_SetPaletteColors
  (c-lambda (SDL_Palette* SDL_Color* int int) int "SDL_SetPaletteColors"))
(define SDL_SetPixelFormatPalette
  (c-lambda (SDL_PixelFormat* SDL_Palette*) int "SDL_SetPixelFormatPalette"))
(define SDL_SetRelativeMouseMode
  (c-lambda (SDL_bool) int "SDL_SetRelativeMouseMode"))
(define SDL_SetRenderDrawBlendMode
  (c-lambda (SDL_Renderer* SDL_BlendMode) int "SDL_SetRenderDrawBlendMode"))
...
(define SDL_SetRenderTarget
  (c-lambda (SDL_Renderer* SDL_Texture*) int "SDL_SetRenderTarget"))
(define SDL_SetSurfaceAlphaMod
  (c-lambda (SDL_Surface* unsigned-int8) int "SDL_SetSurfaceAlphaMod"))
...
(define SDL_SetSurfacePalette
  (c-lambda (SDL_Surface* SDL_Palette*) int "SDL_SetSurfacePalette"))
(define SDL_SetSurfaceRLE
  (c-lambda (SDL_Surface* int) int "SDL_SetSurfaceRLE"))
(define SDL_SetTextInputRect
  (c-lambda (SDL_Rect*) void "SDL_SetTextInputRect"))
(define SDL_SetTextureAlphaMod
  (c-lambda (SDL_Texture* unsigned-int8) int "SDL_SetTextureAlphaMod"))
(define SDL_SetTextureBlendMode
  (c-lambda (SDL_Texture* SDL_BlendMode) int "SDL_SetTextureBlendMode"))
...
(cond-expand
 (sdl:threads
  (define SDL_SetThreadPriority
    (c-lambda (SDL_ThreadPriority) int "SDL_SetThreadPriority")))
 (else #!void))
(define SDL_SetWindowBordered
  (c-lambda (SDL_Window* SDL_bool) void "SDL_SetWindowBordered"))
(define SDL_SetWindowBrightness
  (c-lambda (SDL_Window* float) int "SDL_SetWindowBrightness"))
(define SDL_SetWindowData
  (c-lambda (SDL_Window* nonnull-char-string void*) void* "SDL_SetWindowData"))
(define SDL_SetWindowDisplayMode
  (c-lambda (SDL_Window* SDL_DisplayMode*) int "SDL_SetWindowDisplayMode"))
(define SDL_SetWindowFullscreen
  (c-lambda (SDL_Window* unsigned-int32) int "SDL_SetWindowFullscreen"))
(define SDL_SetWindowGammaRamp
  (c-lambda
   (SDL_Window* unsigned-int16* unsigned-int16* unsigned-int16*)
   int
   "SDL_SetWindowGammaRamp"))
(define SDL_SetWindowGrab
  (c-lambda (SDL_Window* SDL_bool) void "SDL_SetWindowGrab"))
(define SDL_SetWindowIcon
  (c-lambda (SDL_Window* SDL_Surface*) void "SDL_SetWindowIcon"))
(define SDL_SetWindowMaximumSize
  (c-lambda (SDL_Window* int int) void "SDL_SetWindowMaximumSize"))
(define SDL_SetWindowMinimumSize
  (c-lambda (SDL_Window* int int) void "SDL_SetWindowMinimumSize"))
(define SDL_SetWindowPosition
  (c-lambda (SDL_Window* int int) void "SDL_SetWindowPosition"))
(define SDL_SetWindowSize
  (c-lambda (SDL_Window* int int) void "SDL_SetWindowSize"))
(define SDL_SetWindowTitle
  (c-lambda (SDL_Window* nonnull-char-string) void "SDL_SetWindowTitle"))
(define SDL_ShowCursor (c-lambda (int) int "SDL_ShowCursor"))
(define SDL_ShowMessageBox
  (c-lambda (SDL_MessageBoxData* int*) int "SDL_ShowMessageBox"))
(define SDL_ShowSimpleMessageBox
  (c-lambda
   (unsigned-int32 nonnull-char-string nonnull-char-string SDL_Window*)
   int
...
(define SDL_UnionRect
  (c-lambda (SDL_Rect* SDL_Rect* SDL_Rect*) void "SDL_UnionRect"))
...
(define SDL_UnlockAudioDevice
  (c-lambda (SDL_AudioDeviceID) void "SDL_UnlockAudioDevice"))
...
(define SDL_UpdateTexture
  (c-lambda (SDL_Texture* SDL_Rect* void* int) int "SDL_UpdateTexture"))
(define SDL_UpdateWindowSurface
  (c-lambda (SDL_Window*) int "SDL_UpdateWindowSurface"))
(define SDL_UpdateWindowSurfaceRects
  (c-lambda (SDL_Window* SDL_Rect* int) int "SDL_UpdateWindowSurfaceRects"))
(define SDL_UpdateYUVTexture
  (c-lambda
   (SDL_Texture*
    SDL_Rect*
    unsigned-int8*
...
(define SDL_WaitEventTimeout
  (c-lambda (SDL_Event* int) int "SDL_WaitEventTimeout"))
(cond-expand
 (sdl:threads
  (define SDL_WaitThread (c-lambda (SDL_Thread* int*) void "SDL_WaitThread")))
 (else #!void))
(define SDL_WarpMouseInWindow
  (c-lambda (SDL_Window* int int) void "SDL_WarpMouseInWindow"))
(define SDL_WasInit (c-lambda (unsigned-int32) unsigned-int32 "SDL_WasInit"))
(define SDL_WriteBE16
  (c-lambda (SDL_RWops* unsigned-int16) size-t "SDL_WriteBE16"))
(define SDL_WriteBE32
  (c-lambda (SDL_RWops* unsigned-int32) size-t "SDL_WriteBE32"))
(define SDL_WriteBE64
  (c-lambda (SDL_RWops* unsigned-int64) size-t "SDL_WriteBE64"))
(define SDL_WriteLE16
  (c-lambda (SDL_RWops* unsigned-int16) size-t "SDL_WriteLE16"))
(define SDL_WriteLE32
  (c-lambda (SDL_RWops* unsigned-int32) size-t "SDL_WriteLE32"))
(define SDL_WriteLE64
  (c-lambda (SDL_RWops* unsigned-int64) size-t "SDL_WriteLE64"))
